...
moduleForModel('data-line-lohf-resource-characteristic', 'Unit | Serializer | data-line-lohf-resource-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-lohf-resource-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
