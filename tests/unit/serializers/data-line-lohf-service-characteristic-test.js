...
moduleForModel('data-line-lohf-service-characteristic', 'Unit | Serializer | data-line-lohf-service-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-lohf-service-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
